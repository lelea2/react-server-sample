...
var logger = _reactServer.logging.getLogger({ "name": "react-server-sample.components.hello-world", "color": { "server": 147, "client": "rgb(127,127,212)" } });
...
var HelloWorld = function (_React$Component) {
	...
	function HelloWorld(props) {
		...
		_this.state = { exclamationCount: 0 };
		_this.handleClick = function () {
			logger.info('Getting more excited! previously ' + _this.state.exclamationCount + ' excitements.');
